...
function send_message(array $webMailCookie, bool $send) {
	...
	if ($fromDomain && strlen($fromDomain) > 0) {
		$fromDomain = explode('>', $fromDomain)[0]; /* Strip trailing '>' if present */
		$messageid = "<" . generateUUID() . "@" . $fromDomain . ">";
	}

	/*! \todo msg doesn't appear to be used here? */
	$msg = "";
	...
	/*! \todo $msg isn't used above? For the most part, that wouldn't matter, except for the body and Content-Type, for format=flowed support */
